...
import cc.page.study.week9.practice2.rpcfx.core.api.RpcfxResolver;
import cc.page.study.week9.practice2.rpcfx.core.api.RpcResponse;
import cc.page.study.week9.practice2.rpcfx.core.api.ServiceProviderDesc;
import cc.page.study.week9.practice2.rpcfx.core.server.RpcfxInvoker;
...
//		registerService(client, orderService);
	...
	@Bean(name = "cc.page.study.week9.practice2.rpcfx.api.UserService")
	public UserService createUserService(){
		return new UserServiceImpl();
	}

	@Bean(name = "cc.page.study.week9.practice2.rpcfx.api.OrderService")
